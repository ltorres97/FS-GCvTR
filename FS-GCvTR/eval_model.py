...
# FS-GCvTR - Two module GNN-CvTR architecture
...
for epoch in range(1, 10000):
    ...
    roc_scores, gnn_model, transformer_model, gnn_opt, t_opt = model_eval.meta_evaluate() #FS-GCvTR
    ...
    #save_result(epoch, N, exp, "results-exp/mean-FS-GCvTR_tox21_5.txt")
