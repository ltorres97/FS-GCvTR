...
for epoch in range(1, 10000):
    ...
    filename = "results-exp/FS-GCvTR-tox21-5.txt"
    ...
    #if baseline == 0:
     #   save_ckp(checkpoint_gnn, is_best, checkpoint_dir, model_dir, "/FS-GCvTR_GNN_tox21_5.pt", "/FS-GCvTR_GNN_tox21_5_best.pt")
      #  save_ckp(checkpoint_transformer, is_best, checkpoint_dir, model_dir, "/FS-GCvTR_Transformer_tox21_5.pt", "/FS-GCvTR_Transformer_tox21_5_best.pt")
